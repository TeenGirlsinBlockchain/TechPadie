...
const Login = () => {
    ...
    return (
        ...
        <div className="w-full max-w-md bg-white rounded-lg p-6">
          ...
          <div className='text-[12px] mb-4'>We’ve sent you a code to confirm your registration</div>
          <form>
          <div className="mb-4">
          ...
          <button
            ...
            <div className='text-center mt-2'>Dont have an account ? <span className='text-[#227FA1] ' onClick={handleSignUpScreen}>Sign up here</span></div>
